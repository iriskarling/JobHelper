...
<table align="center" width="600"  border="0">
                                                ...
                                                <tr><td COLSPAN=6 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                               <tr><td COLSPAN=6 align="center"> <p><font size="6px">我发布的招聘会信息</font><br></td></tr>
                                               <% }
                                               else{%>
                                             ...
                                             <tr>
                                              ...
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我发布的招聘会信息</font><br></td></tr>
                                                <% }%>
                                                 </table>
        ...
        %>
			...
			<tr>
				<td>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <div class="post-meta clearfix">
                                                               <span class="date">活动时间：<%=col3%>&nbsp;<%=col4%>--<%=col5%></span>&nbsp;&nbsp;
                                                                   ...
                                                                   <span >发布时间：<%=col8 %></span>&nbsp;&nbsp;&nbsp;
                                                                     <a href="JobFairDelete.jsp?FairID=<%=col6 %>">删除信息</a>&nbsp;&nbsp;&nbsp;<a href="JobFairModify.jsp?FairID=<%=col6 %>">修改信息</a>   
                                                        </div>
								...
								<a href="MyPublishJobFair.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyPublishJobFair.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyPublishJobFair.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyPublishJobFair.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

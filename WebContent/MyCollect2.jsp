...
<table align="center" width="600"  border="0">
                                              ...
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我收藏的组队信息</font><br></td></tr>
                                               </table>
...
%>
    ...
    try{  
        ...
        String sql = "select Title,PublishTime,Type,Collection,Project.ProjectID,CollectTime from Project,Collect_Project where Collect_Project.ProjectID=Project.ProjectID and Collect_Project.StudentID='"+username+"' order by CollectTime desc";
        ...
        %>
			...
			<tr>
				<td>
                                <div class="row">
                                        ...
                                        <div class="span8 page-content">
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <h2  class="post-title"><a href="ProjectEach.jsp?ProjectID=<%=col5%>"><%=col1 %></a></h2>

                                                        <div class="post-meta clearfix">
                                                               <span class="date">发布日期：<%=col2%>&nbsp;</span>&nbsp;&nbsp;
                                                                      <span class="category">合作类型：<%=col3 %></span></div>
                                                                    <div  class="post-meta clearfix" align="right"> 
                                                                      <a href="ProjectCollectDelete.jsp?ProjectID=<%=col5%>"class="STYLE4">取消收藏</a>&nbsp;&nbsp;
                                                                      <%
                                                                      if(col4==null)
                                                                    	  col4="0";
                                                                      %>
								...
								<a href="MyCollect2.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyCollect2.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyCollect2.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyCollect2.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

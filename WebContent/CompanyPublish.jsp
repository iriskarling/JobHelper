...
<div align="center">
  <form name="form1" method="post" action="CompanyPublish1.jsp">
  <table width="730" height="408" border="0">
    <tr>
      <td width="181"><span class="STYLE2">公司名称*</span></td>
      <td width="539"><input type="text" name="company" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><span class="STYLE6">联系方式</span></td>
      <td><p class="STYLE6">联系邮箱<span class="STYLE2">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><span class="STYLE6">联系电话</span>

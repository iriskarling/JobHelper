...
<table align="center" width="600"  border="0">
                                                ...
                                                <tr><td COLSPAN=6 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                               <tr><td COLSPAN=6 align="center"> <p><font size="6px">我发布的宣讲会信息</font><br></td></tr>
                                               <% }
                                               else{%>
                                             ...
                                             <tr>
                                              ...
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我发布的宣讲会信息</font><br></td></tr>
                                                <% }%>
                                                 </table>
...
%>
    ...
    try{  
        ...
        String sql = "select Title,Location,Date,StartTime,EndTime,TalkID,Description,PublishTime from Talk where AssistantID='"+username+"' order by PublishTime desc";
        ...
        %>
			...
			<tr>
				<td>
                                        ...
                                        <br>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <div class="post-meta clearfix">
                                                               <span class="date">活动时间：<%=col3%>&nbsp;<%=col4%>--<%=col5%></span>&nbsp;&nbsp;
                                                                      <span class="category">活动地点：<%=col2 %></span></div>
                                                                      <%=col7 %><br>
                                                                   <div  class="post-meta clearfix" align="right">
                                                                   <span >发布时间：<%=col8 %></span>&nbsp;&nbsp;&nbsp;
                                                                     <a href="TalkDelete.jsp?TalkID=<%=col6 %>">删除信息</a>&nbsp;&nbsp;&nbsp;<a href="TalkModify.jsp?TalkID=<%=col6 %>">修改信息</a>
								...
								<a href="MyPublishTalk.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyPublishTalk.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyPublishTalk.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyPublishTalk.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

...
-->
 ...
 <p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center" class="STYLE1">发布项目信息</p>
<p align="center" class="STYLE2">     &nbsp;&nbsp;&nbsp;*为必填信息</p>
<div align="center">
  <form name="form1" method="post" action="ProjectPublish1.jsp">
  <table width="730" height="408" border="0">
    <tr>
      <td width="120"><span class="STYLE2">标题 *</span></td>
      <td width="600"><input type="text" name="title" /></td>
    </tr>
    <tr>
      <td><span class="STYLE2">合作类型 </span></td>
      <td><select name="type">
       <option value="其他">其他</option>
      <option value="学科竞赛类">学科竞赛类</option>
      <option value="社会实践类">社会实践类</option>
      <option value="实验室/项目">实验室/项目</option>
      </select></td>
    </tr>
    <tr>
        ...
        <option value="大一及以上">大一及以上</option>
          <option value="大二及以上">大二及以上</option>
            <option value="大三及以上">大三及以上</option>
              <option value="大四及以上">大四级以上</option>

	 ...
	 String studentName = (String) session.getAttribute("Name");
                ...
                <!-- End of Header -->
                              <table align="center" width="600"  border="0">
                                              ...
                                              <tr>
                                                <td align="right" ><a href="MyCollect.jsp" class="btn">实习</a></td>
                                                <td align="center" width="150"><a href="MyCollect1.jsp" class="btn">兼职</a></td>
                                                <td align="left"><a href="MyCollect2.jsp" class="btn">组队</a></td>
                                              </tr>
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我收藏的兼职信息</font><br></td></tr>
                                               </table>
...
%>
    ...
    try{  
        ...
        String sql = "select Title,PublishTime,District,Collection,Part_timeJob.Part_timeJobID,CollectTime from Part_timeJob,Collect_Part_timeJob where Collect_Part_timeJob.Part_timeJobID=Part_timeJob.Part_timeJobID and Collect_Part_timeJob.StudentID='"+username+"' order by CollectTime desc";
        ...
        %>
			...
			<tr>
				<td>
                                <div class="row">
                                        ...
                                        <br>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                         ...
                                                         <h2  class="post-title"><a href="Part_timeJobEach.jsp?Part_timrJobID=<%=col5%>"><%=col1 %></a></h2>

                                                        <div class="post-meta clearfix">
                                                               <span class="date">发布时间：<%=col2%>&nbsp;</span>&nbsp;&nbsp;
                                                                      <span class="category">工作地点：<%=col3 %></span></div>
                                                                      <div  class="post-meta clearfix" align="right"> 
                                                                         <a href="Part_timeJobCollectDelete.jsp?Part_timeJobID=<%=col5%>"class="STYLE4">取消收藏</a>&nbsp;&nbsp;
                                                                         <%
                                                                      if(col4==null)
                                                                    	  col4="0";
                                                                      %>
								...
								<a href="MyCollect1.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyCollect1.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyCollect1.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyCollect1.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

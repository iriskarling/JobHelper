...
<meta http-equiv="description" content="This is my page">
 ...
 <% try{
	 ...
	 String studentName = (String) session.getAttribute("Name");
            ...
            <img src="images/jobfair.jpg"  alt="Slide 1"/>
		</div>
<%!  
...
%>
    ...
    try{  
        ...
        String sql = "select Title,Date,StartTime,EndTime,Location,Description,PublishTime,Job_Fair.AssistantID from Job_Fair,Assistant where Job_Fair.AssistantID=Assistant.AssistantID and Assistant.Department='"+department+"'";
...
<%     }while(rs.next());
								...
								<a href="JobFair.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="JobFair.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="JobFair.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="JobFair.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

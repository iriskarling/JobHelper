...
-->
 ...
 <p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center" class="STYLE1">修改招聘会信息</p>
<p align="center"class="STYLE2">     &nbsp;&nbsp;&nbsp;*为必填信息</p>
<div align="center">
  <form name="form1" method="post" action="JobFairModify1.jsp">
  <table width="730" height="408" border="0">
    <tr>
      <td width="181"><span class="STYLE2">活动标题 *</span></td>
         <%
                                                  rs = stmt.executeQuery("select Title,Location,Date,StartTime,EndTime,Description,FairID from Job_Fair where FairID='"+FairID+"'");
												       String col1 = "";
												       String col2=  "";
												       String col3 =  "";
												       String col4 =  "";
    ...
    <tr>
      <td><span class="STYLE2">活动地点*</span></td>
      <td><input type="text" name="location" value="<%=col2 %>" ></td>
    </tr>
    <tr>
      <td><span class="STYLE2"> </span></td>
      <td><input type="hidden"name="FairID" value="<%=col7%>" /></td>
    </tr>
    <tr>
      <td><span class="STYLE2">活动日期 *</span></td>
      <td><span class="STYLE2">
        <input class="inline laydate-icon" id="start" name="startDate" style="width:200px; margin-right:10px;"value="<%=col3 %>" /><br>
    <br>
      </span></td>
    </tr>
    <tr>
      <td><span class="STYLE2"><br>
       活动 时间</span></td>
      <td><br><span class="STYLE2">开始：<input type="text" name="startTime" value="<%=col4 %>" /></span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td><span class="STYLE2">活动描述 *</span></td>

...
<form id="Search" name="Search" method="POST" action="" >
		...
		需求关键字:&nbsp;</td>
		<td COLSPAN=3>
		<input type="text" name="PositionKeyword" id="PositionKeyword" style="width:480px; height:20px;">
		</td>
		</tr>
		<tr><td align="left" width="100">
                                   类型选择:&nbsp;</td>
			<td align="left"  COLSPAN=3><font style="font-size:15px;">
			<input type="radio" name="type" value="不限" style="font-family:'Microsoft YaHei';font-size:20px;" checked>不限&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="type" value="学科竞赛类" style="font-family:'Microsoft YaHei';font-size:20px;" >学科竞赛类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="type" value="社会实践类" style="font-family:'Microsoft YaHei';font-size:20px;" >社会实践类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="type" value="实验室/项目" style="font-family:'Microsoft YaHei';font-size:20px;" >实验室/项目&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="type" value="其他" style="font-family:'Microsoft YaHei';font-size:20px;" >其他<br></font></td>
			</tr>
			<tr>
			...
			<option value="大一及以上" >大一及以上</option>
			<option value="大二及以上" >大二及以上</option>
			<option value="大三及以上" >大三及以上</option>
			<option value="大四及以上" >大四及以上</option>
			<option value="研一及以上" >研一及以上</option>
			<option value="研二及以上" >研二及以上</option>
			<option value="研三及以上" >研三及以上</option>
        ...
        while(rs0.next()){
			...
			FROM：<input class="inline laydate-icon" id="start" name="start" style="width:150px; margin-right:10px;">&nbsp;&nbsp;&nbsp;&nbsp;
            TO：<input class="inline laydate-icon" id="end"  name="end" style="width:150px;">		
		</td></tr>
		<tr>
			<td align="left" width="100">
		           排序方式:&nbsp;</td>
...
%>
    ...
    try{  
        ...
        String sql = "SELECT * FROM Project where Department like '%"+department+"%' order by PublishTime desc,Collection desc";
							...
							<article class="format-standard type-post hentry clearfix">
								...
								<header class="clearfix">
									...
									<div class="post-meta clearfix">
										...
										<span class="category">年级要求：<%=Grade %></span> <span class="like-count"><%=collection %></span>
									</div>
									<!-- end of post meta -->
...
<script language="JavaScript">
	...
	function go3() {
		var form = document.getElementById("Search");
		var a="<%=curPage+1%>";
		form.action = "Project.jsp?curPage="+a;
		form.submit();

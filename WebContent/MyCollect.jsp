 ...
 <% try{
	 ...
	 String studentName = (String) session.getAttribute("Name");
                ...
                <!-- End of Header -->
                                              ...
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我收藏的实习信息</font><br></td></tr>
                                               </table>
...
%>
    ...
    try{  
        ...
        String sql = "select Position,PublishTime,CompanyName,Collection,Practise.PractiseID,CollectTime from Practise,Collect_Practise where Collect_Practise.PractiseID=Practise.PractiseID and Collect_Practise.StudentID='"+username+"' order by CollectTime desc";
...
<br>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <h2  class="post-title"><a href="PracticeJobEach.jsp?PractiseID=<%=col5%>"><%=col1 %></a></h2>

                                                        <div class="post-meta clearfix">
                                                               <span class="date">发布日期：<%=col2%>&nbsp;</span>&nbsp;&nbsp;
                                                                      <span class="category">公司：<%=col3 %></span>
                                                                      </div>
                                                                      <div  class="post-meta clearfix" align="right">
                                                                     <a href="PracticeCollectDelete.jsp?PractiseID=<%=col5%>"class="STYLE4">取消收藏</a>&nbsp;&nbsp;
								...
								<a href="MyCollect.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyCollect.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyCollect.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyCollect.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

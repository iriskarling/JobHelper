...
<form id="Search" name="Search" method="POST" action="" >
		...
		职位关键字:&nbsp;</td>
		<td COLSPAN=3>
		<input type="text" name="PositionKeyword" id="PositionKeyword" style="width:450px; height:20px;">
		</td>
		</tr>
		<tr><td align="left" width="100">
		公司关键字:&nbsp;</td>
		<td COLSPAN=3>
		<input type="text" name="CompanyKeyword" id="CompanyKeyword" style="width:450px; height:20px;">
		</td>
		</tr>
		<tr><td align="left" width="100">
                                   实习地点:&nbsp;</td>
...
Gid('s_county').setAttribute('onchange','showArea()');
			...
			<input type="radio" name="request" value="不限" style="font-family:'Microsoft YaHei';font-size:20px;" checked>不限&nbsp;&nbsp;&nbsp;&nbsp;
			<%
	        ...
	        while(rs4.next()){
	        	...
	        	%>
	        	<input type="radio" name="request" value="<%=ss[i]%>" style="font-family:'Microsoft YaHei';font-size:20px;"><%=ss[i]%>&nbsp;&nbsp;&nbsp;&nbsp;
	        	<% 
	        	    i++;
		...
		实习天数:&nbsp;</td>
			<td align="left" COLSPAN=3>
			<input type="radio" name="days" value="0" style="font-family:'Microsoft YaHei';font-size:20px;" checked>不限&nbsp;&nbsp;
			<input type="radio" name="days" value="1" style="font-family:'Microsoft YaHei';font-size:20px;">1天&nbsp;&nbsp;
			<input type="radio" name="days" value="2" style="font-family:'Microsoft YaHei';font-size:20px;">2天&nbsp;&nbsp;
			<input type="radio" name="days" value="3" style="font-family:'Microsoft YaHei';font-size:20px;">3天&nbsp;&nbsp;
			<input type="radio" name="days" value="4" style="font-family:'Microsoft YaHei';font-size:20px;">4天&nbsp;&nbsp;
			<input type="radio" name="days" value="5" style="font-family:'Microsoft YaHei';font-size:20px;">5天&nbsp;&nbsp;
			<input type="radio" name="days" value="6" style="font-family:'Microsoft YaHei';font-size:20px;">6天&nbsp;&nbsp;
			<input type="radio" name="days" value="7" style="font-family:'Microsoft YaHei';font-size:20px;">7天
			</td>
			</tr>
			<tr>
			<td align="left" width="100">
		           实习月数:&nbsp;</td>
			<td align="left" COLSPAN=3>
			<input type="radio" name="months" value="0" style="font-family:'Microsoft YaHei';font-size:20px;" checked>不限&nbsp;&nbsp;
			<input type="radio" name="months" value="1" style="font-family:'Microsoft YaHei';font-size:20px;">1月&nbsp;&nbsp;
			<input type="radio" name="months" value="2" style="font-family:'Microsoft YaHei';font-size:20px;">2月&nbsp;&nbsp;
			<input type="radio" name="months" value="3" style="font-family:'Microsoft YaHei';font-size:20px;">3月&nbsp;&nbsp;
			<input type="radio" name="months" value="4" style="font-family:'Microsoft YaHei';font-size:20px;">4月&nbsp;&nbsp;
			<input type="radio" name="months" value="5" style="font-family:'Microsoft YaHei';font-size:20px;">5月及以上
...
%>
    ...
    try{  
        ...
        String sql = "SELECT * FROM Practise where Department like '%"+department+"%' order by PublishTime desc,Collection desc";
...
<script language="JavaScript">	
	function go3() {
		var form = document.getElementById("Search");
		var a="<%=curPage+1%>";
		form.action = "PracticeJob.jsp?curPage="+a;
		form.submit();

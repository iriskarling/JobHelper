...
-->
 ...
 <p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center" class="STYLE1">修改宣讲会信息</p>
<p align="center"class="STYLE2">     &nbsp;&nbsp;&nbsp;*为必填信息</p>
<div align="center">
  <form name="form1" method="post" action="TalkModify1.jsp">
  <table width="730" height="408" border="0">
    <tr>
      <td width="181"><span class="STYLE2">标题 *</span></td>
         <%
                                                  rs = stmt.executeQuery("select Title,Location,Date,StartTime,EndTime,Description,TalkID from Talk where TalkID='"+TalkID+"'");
												       String col1 = "";
												       String col2=  "";
												       String col3 =  "";
												       String col4 =  "";
    ...
    <tr>
      ...
      <td><input type="hidden"name="TalkID" value="<%=col7%>" /></td>
    </tr>
    <tr>

 ...
 <% try{
	 ...
	 String studentName = (String) session.getAttribute("Name");
                ...
                <!-- End of Header -->
                                              ...
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我投递简历的实习</font><br></td></tr>
                                                 </table>
...
%>
    ...
    try{  
        ...
        String sql = "select Send_Mail.PractiseID,Position,CompanyName,SendTime,FileName,Topic from Send_Mail,Practise where Practise.PractiseID=Send_Mail.PractiseID and Send_Mail.StudentID='"+username+"' order by SendTime desc";
        ...
        %>
			...
			<tr>
				<td>
                                <div class="row">
                                        ...
                                        <br>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <h2  class="post-title"><a href="PracticeJobEach.jsp?PractiseID=<%=col1%>"><%=col2 %></a></h2>

                                                        <div class="post-meta clearfix">
                                                               <span class="category">投递公司：<%=col3%>&nbsp;</span>&nbsp;&nbsp;</div>
                                                               邮件主题：<%=col6 %><br>
                                                               附件名称：<%=col5 %><br>
                                                               发送时间: <%=col4 %><br>
                                                               <p>&nbsp;&nbsp;</p>
								...
								<a href="MySend.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MySend.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MySend.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MySend.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

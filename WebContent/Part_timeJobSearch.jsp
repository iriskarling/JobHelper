...
<form id="Search" name="Search" method="POST" action="" >
		...
		<tr><td align="left" width="120">
			...
			<input type="radio" name="district" value="不限" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("")) out.print( "checked");%>>不限&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="宝山区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("宝山区")) out.print( "checked");%>>宝山区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="杨浦区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("杨浦区")) out.print( "checked");%>>杨浦区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="嘉定区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("嘉定区")) out.print( "checked");%>>嘉定区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="浦东新区" style="font-family:'Microsoft YaHei';font-size:20px;"<% if(District.equals("浦东新区")) out.print( "checked");%> >浦东新区<br>
			<input type="radio" name="district" value="闸北区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("闸北区")) out.print( "checked");%>>闸北区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="松江区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("松江区")) out.print( "checked");%>>松江区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="黄浦区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("黄浦区")) out.print( "checked");%>>黄浦区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="静安区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("静安区")) out.print( "checked");%>>静安区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="崇明县" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("崇明县")) out.print( "checked");%>>崇明县<br>
			<input type="radio" name="district" value="虹口区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("虹口区")) out.print( "checked");%>>虹口区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="金山区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("金山区")) out.print( "checked");%>>金山区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="闵行区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("闵行区")) out.print( "checked");%>>闵行区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="奉贤区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("奉贤区")) out.print( "checked");%>>奉贤区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="长宁区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("长宁区")) out.print( "checked");%>>长宁区<br>
			<input type="radio" name="district" value="普陀区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("普陀区")) out.print( "checked");%>>普陀区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="徐汇区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("徐汇区")) out.print( "checked");%>>徐汇区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="district" value="青浦区" style="font-family:'Microsoft YaHei';font-size:20px;" <% if(District.equals("青浦区")) out.print( "checked");%>>青浦区
			</font>
			</td>
			</tr>
			<tr>
			...
			<option value="不限" <% if(Type.equals("")) out.print( "selected");%>>不限</option>
			<option value="家教" <% if(Type.equals("家教")) out.print( "selected");%>>家教</option>
			<option value="发传单" <% if(Type.equals("发传单")) out.print( "selected");%>>发传单</option>
			<option value="其他" <% if(Type.equals("其他")) out.print( "selected");%>>其他</option>
...
%>
    ...
    try{  
        ...
        sql = "SELECT * FROM Part_timeJob where Department like '%"+department+"%' and (Title like '%"+PositionKeyword+"%' or Description like '%"+PositionKeyword+"%') and (Type like '%"+Type+"%' or Type='不限') and District like '%"+
        District+"%' order by PublishTime desc,Collection desc";
        }
        else{
        	sql = "SELECT * FROM Part_timeJob where Department like '%"+department+"%' and (Title like '%"+PositionKeyword+"%' or Description like '%"+PositionKeyword+"%') and (Type like '%"+Type+"%' or Type='不限') and District like '%"+
        	        District+"%' order by Collection desc,PublishTime desc";
...
function go3() {
	var form = document.getElementById("Search");
	var a="<%=curPage+1%>";
	form.action = "Part_timeJobSearch.jsp?curPage="+a;
	form.submit();

 ...
 <% try{
	 ...
	 String studentName = (String) session.getAttribute("Name");
                ...
                <!-- End of Header -->
                                                ...
                                                <tr><td COLSPAN=6 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                               <tr><td COLSPAN=6 align="center"> <p><font size="6px">我发布的组队信息</font><br></td></tr>
                                               <% }
                                               else{%>
                                             ...
                                             <tr>
                                              ...
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我发布的组队信息</font><br></td></tr>
                                                <% }%>
                                                 </table>
...
%>
    ...
    try{  
        ...
        String sql = "select Title,PublishTime,Type,Collection,ProjectID from Project where PublishID='"+username+"' order by PublishTime desc";
        ...
        %>
			...
			<tr>
				<td>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <div class="post-meta clearfix">
                                                               <span class="date">发布时间：<%=col2%>&nbsp;</span>&nbsp;&nbsp;
                                                                     ...
                                                                     <a href="ProjectDelete.jsp?ProjectID=<%=col5 %>">删除信息</a>&nbsp;&nbsp;&nbsp;<a href="ProjectModify.jsp?ProjectID=<%=col5 %>">修改信息</a>&nbsp;&nbsp;&nbsp;
                                                                      <%
                                                                      if(col4==null)
                                                                    	  col4="0";
                                                                      %>  
								...
								<a href="MyPublishProject.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyPublishProject.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyPublishProject.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyPublishProject.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

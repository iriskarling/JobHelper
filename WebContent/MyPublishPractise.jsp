...
<table align="center" width="600"  border="0">
                                                ...
                                                <tr><td COLSPAN=6 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                               <tr><td COLSPAN=6 align="center"> <p><font size="6px">我发布的实习信息</font><br></td></tr>
                                               <% }
                                               else{%>
                                             ...
                                             <tr>
                                              ...
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我发布的实习信息</font><br></td></tr>
                                                <% }%>
                                                 </table>
...
%>
    ...
    try{  
        ...
        String sql = "select Position,PublishTime,CompanyName,Collection,PractiseID from Practise where AssistantID='"+username+"' order by PublishTime desc";
        ...
        %>
			...
			<tr>
				<td>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <div class="post-meta clearfix">
                                                               <span class="date">发布时间：<%=col2%>&nbsp;</span>&nbsp;&nbsp;
                                                                      <span class="category">公司：<%=col3 %></span></div>
                                                                      <div  class="post-meta clearfix" align="right">
                                                                     <a href="PractiseDelete.jsp?PractiseID=<%=col5 %>">删除信息</a>&nbsp;&nbsp;&nbsp;<a href="PractiseModify.jsp?PractiseID=<%=col5 %>">修改信息</a>
                                                                      <%
                                                                      if(col4==null)
                                                                    	  col4="0";
                                                                      %>
								...
								<a href="MyPublishPractise.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyPublishPractise.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyPublishPractise.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyPublishPractise.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

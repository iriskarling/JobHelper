...
<table align="center" width="600"  border="0">
                                                ...
                                                <tr><td COLSPAN=6 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                               <tr><td COLSPAN=6 align="center"> <p><font size="6px">我发布的公司信息</font><br></td></tr>
                                               <% }
                                               else{%>
                                             ...
                                             <tr>
                                              ...
                                              <tr><td COLSPAN=3 align="center"><p><font size="6px">&nbsp;</font></td></tr>
                                              <tr><td COLSPAN=3 align="center"> <p><font size="6px">我发布的公司信息</font><br></td></tr>
                                                <% }%>
                                                 </table>
...
%>
    ...
    try{  
        ...
        String sql = "select CompanyName,LinkmanName,LinkmanEmail,CompanyID,LinkmanPhone from Company where AssistantID='"+username+"'";
        ...
        %>
			...
			<tr>
				<td>
                                <div class="row">
                                        ...
                                        <br>
                                                ...
                                                <article class=" type-post format-standard hentry clearfix">
                                                        ...
                                                        <h2  class="post-title"><a href="PracticeCompany.jsp?CompanyID=<%=col4%>"><%=col1 %></a></h2>

                                                        <div class="post-meta clearfix">
                                                               <span class="category">联系人：<%=col2%>&nbsp;&nbsp;&nbsp;&nbsp;E_mail：<%=col3%>&nbsp;&nbsp;&nbsp;&nbsp;联系电话：<%=col5%></span>&nbsp;&nbsp;</div>
                                                                      
                                                                      <div  class="post-meta clearfix" align="right">
                                                                     <a href="CompanyDelete.jsp?CompanyID=<%=col4 %>">删除信息</a>&nbsp;&nbsp;&nbsp;<a href="CompanyModify.jsp?company_name=<%=col1%>">修改信息</a>           
								...
								<a href="MyPublishCompany.jsp?curPage=1" class="btn">首页</a>&nbsp;&nbsp; <a
									href="MyPublishCompany.jsp?curPage=<%=curPage-1%>" class="btn">上一页</a>&nbsp;&nbsp;
								<a href="MyPublishCompany.jsp?curPage=<%=curPage+1%>" class="btn">下一页</a>&nbsp;&nbsp;
								<a href="MyPublishCompany.jsp?curPage=<%=pageCount%>" class="btn">尾页</a>&nbsp;&nbsp;

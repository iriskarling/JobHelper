...
%>
        ...
        String sql = "SELECT * FROM Project where ProjectID='"+ProjectID2+"'";
  ...
  <form align="center" >
            ...
            String StartDate=rs.getString("StartDate");if(StartDate.equals("")){StartDate="不限";}
            String EndDate=rs.getString("EndDate");if(EndDate.equals("")){EndDate="不限";}
            ...
            %>
             ...
             <p>&nbsp;</p>
                ...
                <tr ><td COLSPAN=2>
                </td>  <h1 class="post-title">
					<%=title%>
				</h1></tr>
                            <tr>
                                 <td align="left">院系要求：&nbsp;<%=Major %></td>
                                        <td align="left">年级要求：&nbsp;<%=Grade %></td>
                                        </tr>
                                        <tr>  
										<td align="left">合作时间（开始）：&nbsp;<%=StartDate %></td>
										<td align="left">合作时间（结束）：&nbsp;<%=EndDate%></td></tr>
										<tr> 
										 <td align="left">合作类型：&nbsp;<%=Type %></td>
...
max-height: 500px"><%=description %></textarea>
                                ...
                                String sql4 = "SELECT * FROM Collect_Project where StudentID='"+StudentID+"'and ProjectID='"+ProjectID2+"' ";
                                ResultSet rs4 = stat4.executeQuery(sql4); 
                                if(rs4.next()){
                                %>
									<a href="ProjectCollectDelete.jsp?ProjectID=<%=ProjectID2%>" class="btn" >取消收藏</a>
									<%
                                }
                                else{%>
                                	<a href="ProjectCollect.jsp?ProjectID=<%=ProjectID2%>" class="btn" >收&nbsp;藏</a>
                                <% 
                                }
                                stat4.close();
                                rs4.close();
